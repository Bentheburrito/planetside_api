defmodule PS2.APITest do
  use ExUnit.Case, async: true
	...
	test "Ensure proper query encoding" do
		...
		assert PS2.API.encode(q) == {:ok, "test_col?c:lang=en&c:limit=12&c:join=test_col_join^hide:some_other_field'another_field^inject_at:name^show:some_field&c:tree=field:some_field^list:1&c:sort=key:1"}
